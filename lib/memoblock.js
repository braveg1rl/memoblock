...
(function() {
  var collect, containsPromises, eachSeries, isPromise, makePromise, memoblock, _ref;

  _ref = require("faithful"), isPromise = _ref.isPromise, eachSeries = _ref.eachSeries, collect = _ref.collect, makePromise = _ref.makePromise;
      ...
      return makePromise(function(cb) {
        ...
        iterate = function(memo) {
          ...
          if (r && typeof r.then === "function") {
            ...
            return faithful.collect(memo).then((function(m) {
              return iterate(m);
            }), function(err) {
              return cb(err);
            });
